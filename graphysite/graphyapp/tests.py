...
class ImageStoryModelTests(TestCase):
    """Tests for ImageStory model"""
    def test_timestamp_created(self):
        """Test if timestamp is added during model creation"""
        img_story = ImageStory(story_name='test_story', grapher_name='yash',
...
class VideoStoryModelTests(TestCase):
    """Tests for VideoStory model"""
    def test_timestamp_created(self):
        """Test if timestamp is added during model creation"""
        img_story = VideoStory(story_name='test_story', grapher_name='yash',
                               story_description='this is a story')
        img_story.save()
        self.assertIsNotNone(img_story.created_time)
...
class StoryViewTests(TestCase):
    ...
    def test_one_story(self):
        ...
        img_story = ImageStory(story_name='test_story', grapher_name='yash',
                               story_description='this is a story', story_image="test")
        img_story.save()
        response = self.client.get(reverse('graphyapp:stories'))
    ...
    def test_story_order(self):
        """If multiple image and video stories exist, the list of stories should be
        ordered by timestamp"""
        img_story = ImageStory(story_name='test_story', grapher_name='yash',
                               story_description='this is a story', story_image="test")
        img_story.save()
        img_story2 = ImageStory(story_name='test_story2', grapher_name='yash',
                                story_description='this is a story', story_image="test2")
        img_story2.save()
        video_story = VideoStory(story_name='test_story', grapher_name='yash',
                                 story_description='this is a story', story_video="test_vid")
        video_story.save()
        response = self.client.get(reverse('graphyapp:stories'))
